      ...
      <div className="bg-surface-container rounded-2xl p-6 mb-4">
        ...
        <div className="flex items-center justify-center gap-6 mb-4">
          <button
            ...
            disabled={score <= 1}
            className="w-14 h-14 rounded-full bg-surface-container-high border border-outline-variant/40 flex items-center justify-center active:scale-90 transition-transform disabled:opacity-30"
          >
...
export default function ScoringPage() {
  ...
  return (
    <div className="px-4 py-6">
      ...
      {/* Score Summary Bar */}
      <div className="bg-surface-container-high rounded-xl p-4 mt-5 flex items-center justify-between">
        <div>
